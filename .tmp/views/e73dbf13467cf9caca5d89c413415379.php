            ...
            <div class="row g-4 align-items-center">
                <div class="col-lg-7">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-primary btn-lg rounded-pill px-4">
        ...
        <div class="row g-4">
            <div class="col-lg-7">
                <div class="feature-card h-100">
                    ...
                    <p class="text-muted mb-4">Grafik utama tetap tersedia, tapi sekarang lebih fokus pada tren nilai
                        agar halaman depan terasa cepat dan bersih.</p>
