...
<head>
    ...
    <style>
        body {
            ...
            place-items: center;
            background:
                radial-gradient(circle at top left, rgba(225, 179, 84, .22), transparent 30%),
                radial-gradient(circle at bottom right, rgba(18, 40, 108, .18), transparent 32%),
        ...
        .auth-hero {
            background: linear-gradient(160deg, rgba(13, 30, 79, .98), rgba(18, 40, 108, .92));
            color: #fff;
            padding: 3rem;
            position: relative;
        }
...
<body>
    <div class="auth-shell">
        <section class="auth-hero">
            ...
            <p class="text-white-50 fs-5 mb-4">Akses landing page sekolah, data akademik, dashboard peran, dan
