...
<head>
    ...
    body {
        ...
        place-items: center;
        background:
            radial-gradient(circle at top left, rgba(215, 184, 106, .12), transparent 30%),
            radial-gradient(circle at bottom right, rgba(82, 100, 143, .10), transparent 32%),
    ...
    .auth-hero {
        background: linear-gradient(160deg, rgba(255, 255, 255, .88), rgba(238, 244, 251, .88));
        color: #263247;
        padding: 3rem;
        position: relative;
    }
    ...
    .auth-hero::after {
        ...
        right: -100px;
        bottom: -120px;
        background: radial-gradient(circle, rgba(215, 184, 106, .18), transparent 70%);
    }
    ...
    .auth-logo {
        ...
        display: grid;
        place-items: center;
        box-shadow: 0 16px 34px rgba(49, 64, 98, .16), inset 0 0 0 1px rgba(82, 100, 143, .10);
...
<body>
    <div class="auth-shell">
        <section class="auth-hero">
            ...
            <p class="text-muted fs-5 mb-4">Akses landing page sekolah, data akademik, dashboard peran, dan
                rekomendasi sekolah dari satu sistem yang konsisten.</p>

            <div class="row g-3">
                <div class="col-sm-6">
                    <div class="info-card">
                        <div class="small text-muted">Akses Cepat</div>
        ...
        <section class="auth-panel">
            <div class="d-flex justify-content-between align-items-start gap-3 mb-4">
                ...
                <div class="rounded-4 p-3" style="background:rgba(18,40,108,.08);color:#12286C;">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ route('home') }}#kontak" class="text-decoration-none text-success fw-semibold">Butuh
                        bantuan?</a>
                </div>
            ...
            <p class="text-center text-muted mb-0">
                Belum punya akun?
                <a href="{{ route('register') }}" class="text-decoration-none fw-semibold text-success">Daftar di
                    sini</a>
            </p>
        </section>
    </div>
