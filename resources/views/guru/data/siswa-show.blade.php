        ...
        <div class="card text-center">
            <div class="card-body py-4">
                ...
                <div class="text-start small">
                    <div class="py-1 border-bottom d-flex justify-content-between"><span class="text-muted">Orang Tua</span><span>{{ $siswa->nama_orangtua }}</span></div>
                    <div class="py-1 border-bottom d-flex justify-content-between"><span class="text-muted">L/P</span><span>{{ $siswa->jenis_kelamin==='L'?'Laki-laki':($siswa->jenis_kelamin==='P'?'Perempuan':'-') }}</span></div>
                    <div class="py-1 d-flex justify-content-between"><span class="text-muted">Tgl Lahir</span><span>{{ $siswa->tanggal_lahir?->format('d M Y')??'-' }}</span></div>
                </div>
                <a href="{{ route('guru.siswa.index') }}" class="btn btn-sm btn-outline-secondary w-100 mt-3">← Kembali</a>
            </div>
        </div>
    </div>
    <div class="col-md-8">
        ...
        <div class="card">
            <div class="card-header fw-semibold d-flex justify-content-between align-items-center">
                <span><i class="bi bi-calendar-event me-2"></i>Kegiatan</span>
                <a href="{{ route('guru.kegiatan.create') }}" class="btn btn-sm btn-outline-primary">+ Tambah</a>
            </div>
            <div class="table-responsive">
                <table class="table table-sm mb-0">
