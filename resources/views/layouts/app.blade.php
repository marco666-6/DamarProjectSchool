...
<head>
    ...
    @php $faviconSchoolInfo = \App\Models\SekolahInfo::getInstance(); @endphp
    <link rel="icon" type="image/png" href="{{ $faviconSchoolInfo->logo_url }}">
    <link rel="shortcut icon" href="{{ $faviconSchoolInfo->logo_url }}">
    ...
    * {
    ...
    .chart-toolbar .form-select {
        border-radius: 14px;
        border-color: rgba(18, 40, 108, .12);
        min-width: 120px;
    }
            ...
            <div class="sidebar-brand">
                <div class="d-flex align-items-center gap-3">
                    <div class="sidebar-brand-badge">
                        @php $schoolInfo = $faviconSchoolInfo; @endphp
                        <img src="{{ $schoolInfo->logo_url }}" alt="Logo sekolah">
                    </div>
                    <div>
                        <h5>{{ auth()->user()->isAdmin() ? 'Admin Hub' : (auth()->user()->isGuru() ? 'Teacher Hub' : 'Parent Hub') }}
                        </h5>
                ...
                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
                    <div class="d-flex align-items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="page-subtitle mb-0">@yield('page-subtitle', 'Pantau data, aksi cepat, dan insight
                                penting dari satu tempat.') </p>
                        </div>
                    </div>
