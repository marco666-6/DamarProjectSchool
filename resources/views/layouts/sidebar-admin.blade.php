...
<a href="{{ route('admin.mata-pelajaran.index') }}"
    class="nav-link {{ request()->routeIs('admin.mata-pelajaran.*') ? 'active' : '' }}">
...
<a href="{{ route('admin.sekolah-rekomendasi.index') }}"
    class="nav-link {{ request()->routeIs('admin.sekolah-rekomendasi.*') ? 'active' : '' }}">
    <i class="bi bi-building"></i> Data SMP Batam
</a>

<div class="nav-section">Pengaturan</div>
<a href="{{ route('admin.sekolah-info.edit') }}"
    class="nav-link {{ request()->routeIs('admin.sekolah-info.*') ? 'active' : '' }}">
