...
@section('content')
<div class="card">
    <div class="card-header fw-semibold"><i class="bi bi-calendar-event me-2"></i>Daftar Kegiatan Siswa</div>
    <div class="card-body border-bottom pb-3">
        <form method="GET" class="row g-2">
            <div class="col-md-5"><input type="text" name="search" class="form-control form-control-sm" placeholder="Cari kegiatan..." value="{{ request('search') }}"></div>
            <div class="col-md-4">
            ...
            <div class="col-md-3 d-flex gap-1">
                ...
                <a href="{{ route('user.data.kegiatan') }}" class="btn btn-sm btn-outline-secondary">Reset</a>
            </div>
        </form>
    </div>
    <div class="table-responsive">
        <table class="table table-hover mb-0">
            <thead class="table-light">
                <tr><th class="ps-3">Siswa</th><th>Kegiatan</th><th>Jenis</th><th>Tanggal</th><th>Prestasi</th><th>Tingkat</th></tr>
            </thead>
            <tbody>
